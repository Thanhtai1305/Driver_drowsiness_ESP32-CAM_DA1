...
datagen = ImageDataGenerator(rescale=1./255, validation_split=0.2)  # Chia 80% train, 20% val
...
model = Sequential([
    Conv2D(32, (3,3), activation='relu', input_shape=(24, 24, 1)),  # 32 bộ lọc
    MaxPooling2D(2,2),  # Lớp giảm kích thước
